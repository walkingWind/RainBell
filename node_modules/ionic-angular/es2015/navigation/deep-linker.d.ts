...
export declare class DeepLinker {
     ...
     * @internal
     */
    navChange(navId: string, direction: string): void;
     ...
     * @internal
     */
    createUrl(navContainer: NavigationContainer, nameOrComponent: any, data: any, prepareExternalUrl?: boolean): string;
    /**
...
/**
   ...
   * @internal
   */
export declare function _loadViewForSegment(navContainer: NavigationContainer, segment: NavSegment, done: Function): any;
