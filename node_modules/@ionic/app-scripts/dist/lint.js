...
function lintUpdateWorker(context, _a) {
    ...
    return getLintConfig(context, tsLintConfig)
        .then(function (tsLintConfig) { return lint_utils_1.lintFiles(context, tsConfig, tsLintConfig, filePaths, { typeCheck: typeCheck }); })
        .catch(function () { });
}
exports.lintUpdateWorker = lintUpdateWorker;
function lintApp(context, _a) {
    var tsConfig = _a.tsConfig, tsLintConfig = _a.tsLintConfig, typeCheck = _a.typeCheck;
    var files = lint_factory_1.getFileNames(context, tsConfig);
    return lint_utils_1.lintFiles(context, tsConfig, tsLintConfig, files, { typeCheck: typeCheck });
}
